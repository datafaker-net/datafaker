...
* PR #635 - Expand SV local names by @robosoul in https://github.com/datafaker-net/datafaker/pull/638
* PR #637 - Expand DK local names by @robosoul in https://github.com/datafaker-net/datafaker/pull/640
* PR #636 - Expand NO local names by @robosoul in https://github.com/datafaker-net/datafaker/pull/639
...
* PR #642 - Language code for Denmark is 'da' by @robosoul in https://github.com/datafaker-net/datafaker/pull/643
* PR #644 - reusable merge of male/female names in the first_name collection by @robosoul in https://github.com/datafaker-net/datafaker/pull/645
