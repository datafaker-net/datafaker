...
public class FinancialTerms extends AbstractProvider<BaseProviders> {
    ...
    public String noun() {
        return noun(faker.selection().option(FinancialTerms.Category.class));
    }
    ...
    public String verb() {
        return verb(faker.selection().option(FinancialTerms.Category.class));
    }
    ...
    public String adjective() {
        return adjective(faker.selection().option(FinancialTerms.Category.class));
    }
