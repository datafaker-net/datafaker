...
public class Http extends AbstractProvider<BaseProviders> {
    ...
    public String userAgent() {
        Browser browser = faker.selection().option(Browser.class);
    ...
    public String responseBody() {
        return resolve("http.response_body." + faker.selection().option(TEXT_BODY_TYPES));
    }
    ...
    private String randomStatusEntry() {
        String category = faker.selection().option(ALL_STATUS_CATEGORIES);
