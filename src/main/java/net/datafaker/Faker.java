...
import net.datafaker.providers.science.ScienceProviders;
...
public class Faker extends BaseFaker implements BaseProviders, SportProviders, FoodProviders, ScienceProviders, EntertainmentProviders, VideoGameProviders {
    public Faker() {
    }
