...
public class Faker extends BaseFaker {
    ...
    public Faker(Locale locale, Random random) {
        this(locale, new RandomService(random.nextLong()));
    }
    ...
    public Faker(FakeValuesService fakeValuesService, RandomService randomService) {
        super(fakeValuesService, randomService);
    }
    ...
    /**
     * Allows for the addition of paths to files with custom data. Data should be in YAML format.
     *
