 ...
 * https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20210000510 and the description at
  ...
  private int getControlDigit(
    ...
    final int sum =
        yearDigit2
            + dayDigit2
            + uinDigit1
            + (yearDigit1 + dayDigit1 + genderDigit) * 3
            + (monthDigit2 + uinDigit3) * 7
            + (monthDigit1 + uinDigit2) * 9;
    return (10 - sum % 10) % 10;
  }
